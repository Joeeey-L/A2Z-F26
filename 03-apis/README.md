...
- [Data and APIs slides](https://docs.google.com/presentation/d/1KJ5kLIBhMlnYKIM_L5xKd6yUQyvAXZFZ38RbXTZQc5E/edit?usp=sharing)

## JavaScript: Fetch, Promises, and JSON
...
- 🔗 [loadJSON()](https://p5js.org/reference/p5/loadjson/) - p5.js 2.0 docs!
...
- 📕 [Excavating AI: The Politics of Images in Machine Learning Training Sets](https://excavating.ai/) by Kate Crawford and Trevor Paglen
...
2. Document your experience working with the library, API, or data source in a blog post and consider the following questions stemming from the [Excavating AI](https://excavating.ai/) reading.
   ...
   - What potential harms could result from the collection, use (or misuse) of the data?
